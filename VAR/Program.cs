...
namespace VAR
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Ограничения var
            //Не может быть параметром метода
            //Не может быть типом возвращаемого значения
            //Не может быть полем класса (Даже если присвоить значение)

            //Используется только в локальном контексте в каком-то методе
            //Для переменной, принимающей результат какого-либо метода
